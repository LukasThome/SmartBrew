...
float anguloyxz, angulo, anguloGraus;
    ...
    while (client.connected()) {
      if (client.available()) {
       ...
       delay(100);  
            ...
            client.println("<html>");
            client.println("<head></head><body><h1>ESP8266 + MPU6050 GRUPO 9</h1><h3>Temperatura em Celsius: ");
            client.println(Tmp/340.00+36.53);
            client.println("</h3><h3>Eixo X ");
            client.println(mediaLeiturasX);
            client.println("</h3><h3>Eixo Y");
            ...
            client.println("</h3><h3>Angulo em Graus");
            client.println(anguloGraus);
